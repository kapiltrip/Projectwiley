...
\begin{figure}[tbp]
\centering
\wileyfig{12_gpu_sta_taskflow.png}{CPU--GPU heterogeneous multicorner STA taskflow from \cite{ref22}, showing partitioned edge-copy, table-copy, arc-copy, delay computation, and propagation.}
...
\begin{figure}[tbp]
\centering
\wileyfig{13_gpu_pba_preprocess.png}{GPU-accelerated path-based-analysis preprocessing from \cite{ref21}, illustrating path-constraint handling and rank-based graph preparation before parallel PBA kernels.}
